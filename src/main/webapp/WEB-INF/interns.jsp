...
<section class="dark:bg-gray-900 px-6 py-24 h-screen">
    <form name='myForm' action='interns-list' method="post">
        <div class="flex justify-center dark:bg-gray-900 p-8">
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <td class="w-4 p-4">
                                <div class="flex items-center">
                                    <a href="${pageContext.request.contextPath}/intern?id=${intern.internId}"
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/intern-group?id=${intern.internGroupByGroupId.groupId}"
                                   class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit ✏️</a>
                            ...
                            <td class="px-6 py-4">
                                <input type="text" name="firstName_${intern.internId}" value="${intern.firstName}"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </td>
                            <td class="px-6 py-4">
                                <input type="text" name="lastName_${intern.internId}" value="${intern.lastName}"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </td>
                            <td class="px-6 py-4">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox"
                                           name="hasCdc_${intern.internId}" ${intern.hasCdc ? "checked" : ""}
                                           class="sr-only peer">
                            ...
                            <td class="px-6 py-4">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox"
                                           name="hasVisitSheet_${intern.internId}" ${intern.hasVisitSheet ? "checked" : ""}
                                           class="sr-only peer">
                                    <div class="w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                                </label>
                            </td>
                            <td class="px-6 py-4">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox"
                                           name="hasTestSheet_${intern.internId}" ${intern.hasTestSheet ? "checked" : ""}
                                           class="sr-only peer">
                                    <div class="w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                                </label>
                            </td>
                            <td class="px-6 py-4">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox"
                                           name="hasOnlineSurvey_${intern.internId}" ${intern.hasOnlineSurvey ? "checked" : ""}
                                           class="sr-only peer">
                                    <div class="w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                                </label>
                            </td>
                            ...
                            <td class="px-6 py-4">
                                <input type="date" name="startDate_${intern.internId}"
                                       value="${intern.internshipByInternshipId.startDate}"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </td>
                            <td class="px-6 py-4">
                                <input type="date" name="endDate_${intern.internId}"
                                       value="${intern.internshipByInternshipId.endDate}"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </td>
                            <td class="px-6 py-4">
                                <a href="${pageContext.request.contextPath}/company?id=${intern.internshipByInternshipId.companyByCompanyId.companyId}"
                                   class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit ✏️</a>
                            ...
                            <td class="px-6 py-4">
                                <input type="text" name="managerName_${intern.internId}"
                                       value="${intern.internshipByInternshipId.managerName}"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </td>
                            <td class="px-6 py-4">
                                <input type="number" name="noteTech_${intern.internId}" min="0" max="20" step="0.1"
                                       value="${intern.internshipByInternshipId.noteTech}"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </td>
                            <td class="px-6 py-4">
                                <input type="number" name="noteCom_${intern.internId}" min="0" max="20" step="0.1"
                                       value="${intern.internshipByInternshipId.noteCom}"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </td>
                        </tr>
                    </c:forEach>
                    <tr>
                        <td colspan="0">
                            <a href="${pageContext.request.contextPath}/intern"
                               class="font-medium text-blue-600 dark:text-blue-500 hover:underline">➕ Add a Student</a>
                        </td>
                    </tr>
                    </tbody>
                </table>
        ...
        <div class="flex justify-center items-center  dark:bg-gray-900">
            ...
            <a href="${pageContext.request.contextPath}/company"
               class="text-white bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800">💼
                Add Company</a>
        </div>
    </form>
